...
# Now add this key-value pair to the dictionary: NIKE = 8
shoe_count['NIKE'] = 8
print(shoe_count)

# # # Now in the next 3 lines below, add the following key:value pairs, modeling after how Jordan 13 & NIKE were added:
...
# print(sum(shoe_count.values()))
# # # # Write here how many total pairs of shoes are in the inventory: 
print(sum(shoe_count.values()))
...
savings["January"] = 4536356354
print(savings["January"])
